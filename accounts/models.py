...
class Job(models.Model):
    ...
    exact_location = models.TextField(
        default="", help_text="Exact address/location for the job"
    )
    ...
    image = models.ImageField(
        ...
        blank=True,
        null=True,
        help_text="Upload a photo of the job",
    )
...
class Negotiation(models.Model):
    ...
    quotation = models.ForeignKey(
        Quotation, on_delete=models.CASCADE, related_name="negotiations"
    )
    job = models.ForeignKey(Job, on_delete=models.CASCADE, related_name="negotiations")
    worker = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="negotiations_initiated"
    )
    customer = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="negotiations_received"
    )
...
class Favorite(models.Model):
    ...
    worker = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="favorite_of"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    ...
    def __str__(self):
        return f"{self.customer.name} favorited {self.worker.name}"
