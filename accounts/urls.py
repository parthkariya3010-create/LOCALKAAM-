...
urlpatterns = [
    ...
    path(
        "customer/job/<int:job_id>/quotations/",
        views.view_quotations,
        name="view_quotations",
    ),
    path(
        "customer/quotation/<int:quotation_id>/accept/",
        views.accept_quotation,
        name="accept_quotation",
    ),
    path(
        "customer/quotation/<int:quotation_id>/reject/",
    ...
    path(
        "worker/availability/delete/<int:availability_id>/",
        views.delete_availability,
        name="delete_availability",
    ),
    path(
        "worker/job/<int:job_id>/quotation/",
        views.submit_quotation,
        name="submit_quotation",
    ),
    path(
        "worker/job/<int:job_id>/complete/",
        views.mark_job_completed,
        name="mark_job_completed",
    ),
    path(
        "customer/job/<int:job_id>/review/", views.create_review, name="create_review"
    ),
    path("profile/", views.profile_view, name="profile"),
    path("profile/edit/", views.edit_profile, name="edit_profile"),
    path(
        "customer/quotation/<int:quotation_id>/negotiate/",
        views.start_negotiation,
        name="start_negotiation",
    ),
    path(
        "customer/negotiations/",
        views.customer_negotiations,
        name="customer_negotiations",
    ),
    path("worker/negotiations/", views.worker_negotiations, name="worker_negotiations"),
    path(
        "worker/job/<int:job_id>/negotiate/",
        views.worker_start_negotiation,
        name="worker_start_negotiation",
    ),
    path(
        "negotiation/<int:negotiation_id>/",
        views.negotiation_detail,
        name="negotiation_detail",
    ),
    path(
        "favorite/toggle/<int:worker_id>/",
